...
CREATE TABLE `settings_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='菜单模块';
...
INSERT INTO `settings_module` VALUES ('34', 'cs', '', '0', 'asdfasfd', 'fa fa-fw fa-simplybuilt', '1', '0');
...
CREATE TABLE `settings_url` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `url` (`url`)
) ENGINE=InnoDB AUTO_INCREMENT=263 DEFAULT CHARSET=utf8 COMMENT='功能链接（菜单链接）';

-- ----------------------------
-- Records of settings_url
-- ----------------------------
INSERT INTO `settings_url` VALUES ('1', '管理员列表', '/users/lists', '33', '1', '1', '', '0', 'fa fa-fw fa-user-secret', '1', '0', '1');
INSERT INTO `settings_url` VALUES ('260', '模块列表', '/Setting/modulelist/', '1', '1', '1', '', '0', 'fa fa-fw fa-archive', '1', '0', '1');
INSERT INTO `settings_url` VALUES ('261', '应用列表', '/Setting/urllist/', '1', '1', '1', '', '0', 'fa fa-fw fa-medium', '3', '0', '1');
INSERT INTO `settings_url` VALUES ('262', 'cs', 'aaa', '34', '0', '1', '', '0', 'fa fa-fw fa-shirtsinbulk', '1', '0', '1');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('132', 'admin', 'c3284d0f94606de1fd2af172aba15bf3', null, null, 'admin', null, '1', '1', '0', '0', '137012933333', null, null, null, null, null, null, null, null, '0', '0', null);
INSERT INTO `user` VALUES ('133', 'aaa', '47bce5c74f589f4867dbd57e9ca9f808', null, null, 'aaa', null, '1', '1', '0', '0', '111', null, null, null, null, null, null, null, null, '0', '0', null);
